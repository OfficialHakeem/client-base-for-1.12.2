...
public class DoubleComponent extends Component {
    ...
    public void renderComponent() {
        ...
        Gui.drawRect(parent.parent.getX() + 1, parent.parent.getY() + offset, parent.parent.getX() + (int) sliderWidth - 1, parent.parent.getY() + offset + 15, Xena.settingsManager.getSettingID("ClickGUIRainbow").getValBoolean() ? RainbowUtil.getMultiColour().getRGB() : GUIColourUtil.getGUIColour());
        ...
        FontUtil.drawText(this.set.getName() + ChatFormatting.GRAY + " " + this.set.getValueDouble(), parent.parent.getX() + 4, parent.parent.getY() + offset + 3, -1);
    }
